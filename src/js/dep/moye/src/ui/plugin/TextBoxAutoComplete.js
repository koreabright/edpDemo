...
define(function (require) {
    ...
    var TextBoxAutoComplete = Plugin.extend(/** @lends module:TextBoxAutoComplete.prototype */{
        ...
        activate: function (textbox) {
            ...
            var focusHandler = lib.debounce.call(
                this,
                $.proxy(this.onFocus, this),
                this.delay
            );

            var blurHandler = lib.debounce.call(
                this,
            ...
            textbox.on('focus', focusHandler);
            textbox.on('blur', blurHandler);
        ...
        fill: function (key, data) {
            ...
            if (!data || !count || !this.validateSource(data)) {
                return this.textbox;
            }
